...
object ContentRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val productTagsDF = spark.read
      ...
      .as[Product]
      .map(
        // tags 分隔符是｜， 这里 判断，如果是｜ 则换位空格，否则保留
    ...
    rescaledDataDF.show(false)

    // TODO tf-idf和als的区别， als有评分可以直接获得features特征向量， tf-idf没有评分，需要计算获得features
